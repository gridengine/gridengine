...
#define MSG_CULL_POINTER_GETREF_NULLELEMENTFORX_S        _MESSAGE(41152, _("!!!!!!!!!! lGetRef(): got NULL element for %s !!!!!!!!!!\n"))
...
#define MSG_CULL_GETREF_NOSUCHNAMEXYINDESCRIPTOR_IS      _MESSAGE(41153, _("lGetREF: no such name (%d, %s) in descriptor\n"))
