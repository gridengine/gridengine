...
public class JobSubmitter {
    ...
    public static int submitJob(ClusterConfig cluster, String [] args) throws IOException, InterruptedException {
        ...
        String qsub = cluster.getSgeRoot()
        + File.separatorChar + "bin"
                + File.separatorChar + arch
                + File.separatorChar + "qsub";
        ...
        String [] env = new String [] {
            "SGE_ROOT=" + cluster.getSgeRoot(),
            "SGE_CELL=" + cluster.getSgeCell(),
    ...
    public static synchronized String getArch(ClusterConfig cluster) throws IOException {
        ...
        if(arch == null) {
            ...
            try {
                String cmd = cluster.getSgeRoot() + File.separatorChar + "util"
                        + File.separatorChar + "arch";
