...
#define MSG_SEC_RESPONSEFAILED_SUSUS      _MESSAGE(55015, _("failed get sec_response from ("SFN":"U32CFormat":"SFN":"U32CFormat"):"SFN"\n"))
...
#define MSG_SEC_HANDLEANNOUNCEFAILED_SSU _MESSAGE(55044, _("failed handle announce for ("SFN":"SFN":"U32CFormat")\n"))
#define MSG_SEC_MSGDECFAILED_SSU         _MESSAGE(55045, _("failed decrypt message ("SFN":"SFN":"U32CFormat")\n"))
