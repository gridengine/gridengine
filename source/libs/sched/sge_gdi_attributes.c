...
const char *attr_name 
   ...
   scaling = sge_gdi_host_scaling(me.qualified_hostname, attr_name);
   sge_gdi_shutdown();
...
const char *attr_name 
   ...
   attr = sge_gdi_host_attribute(me.qualified_hostname, attr_name);
   sge_gdi_shutdown();
...
u_long32 jobid 
   ...
   nslots = sge_gdi_host_nslots(me.qualified_hostname, jobid);
