...
LISTDEF(AULNG_Type)
   SGE_HOST(AULNG_href, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE)
...
LISTDEF(ABOOL_Type)
   SGE_HOST(ABOOL_href, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE)
...
LISTDEF(ATIME_Type)
   SGE_HOST(ATIME_href, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE)
...
LISTDEF(AMEM_Type)
   SGE_HOST(AMEM_href, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE)
...
LISTDEF(AINTER_Type)
   SGE_HOST(AINTER_href, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE)
...
LISTDEF(ASTRING_Type)
   SGE_HOST(ASTRING_href, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE)
...
LISTDEF(ASTRLIST_Type)
   SGE_HOST(ASTRLIST_href, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE)
...
LISTDEF(AUSRLIST_Type)
   SGE_HOST(AUSRLIST_href, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE)
...
LISTDEF(APRJLIST_Type)
   SGE_HOST(APRJLIST_href, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE)
...
LISTDEF(ACELIST_Type)
   SGE_HOST(ACELIST_href, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE)
...
LISTDEF(ASOLIST_Type)
   SGE_HOST(ASOLIST_href, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE)
...
LISTDEF(AQTLIST_Type)
   SGE_HOST(AQTLIST_href, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE)
