...
public class JobMonitor extends JFrame {
   ...
   class JobTableModel extends AbstractTableModel implements Runnable {
      ...
      public JobSummary getJob(int rowIndex) {
         return (JobSummary)jobList.get(rowIndex);
      }
      ...
      public Object getValueAt(int rowIndex, int columnIndex) {
         synchronized(jobList) {
            ...
            switch(columnIndex) {
               case 0: return js.getName();
               case 1: return js.getState();
               case 2: return js.getUser();
   ...
   interface JobTableModelListener {
   ...
   class ConnectionHistory implements JobTableModelListener {
      ...
      public void save() {
         ...
         while(iter.hasNext()) {
            prefs.put("url" + i, (String)iter.next());
            i++;
         }
         while(i<10) {
            prefs.remove("url"+i);
         ...
         if(SwingUtilities.isEventDispatchThread()) {
            ...
            if(connections.contains(url)) {
               ...
               while(connections.size() > 10) {
                  String con =(String)connections.removeLast();
   ...
   class StatusPanel extends JPanel implements JobTableModelListener  {
      ...
      private JLabel jobCountLabel = new JLabel("# Jobs: " );
   ...
   class ConnectAction extends AbstractAction {
      ...
      public void actionPerformed(ActionEvent e) {
         ...
         if(url == null) {
            String url = JOptionPane.showInputDialog(JobMonitor.this, 
                                                     "Enter Grid Engine connection url:",
