...
public class JQueueGeneralPanel extends JPanel {
	...
	protected void initGUI() {
		...
		*/
		...
		layout.constrain(this, qname,    2,1,2,1, GridBagConstraints.HORIZONTAL, GridBagConstraints.NORTHWEST, 1.0, 0.0, 4,4,4,4);
		layout.constrain(this, hostname, 2,2,2,1, GridBagConstraints.HORIZONTAL, GridBagConstraints.NORTHWEST, 1.0, 0.0, 4,4,4,4);
		layout.constrain(this, tmpdir,   2,3,1,1, GridBagConstraints.HORIZONTAL, GridBagConstraints.NORTHWEST, 1.0, 0.0, 4,4,4,4);
		layout.constrain(this, jobslots, 2,4,1,1, GridBagConstraints.HORIZONTAL, GridBagConstraints.NORTHWEST, 1.0, 0.0, 4,4,4,4);
		 
		layout.constrain(this, new JPanel(), 1,300, 200,1, GridBagConstraints.BOTH, GridBagConstraints.NORTH, 1.0, 1.0, 0,0,0,0);
		//layout.constrain(this, new JPanel(), 100,1, 1,100, GridBagConstraints.BOTH, GridBagConstraints.NORTH, 1.0, 1.0, 0,0,0,0);
		debug.DEXIT();
	}


	//*****************************************
	//* get and set functions (without debug)   *
	//*****************************************
