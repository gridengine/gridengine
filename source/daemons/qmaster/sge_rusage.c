                 ...
                 bool intermediate)
{
   ...
   ret = sge_dstring_sprintf(buffer, ACTFILE_FPRINTF_FORMAT, 
          ...
          reporting_get_double_usage_sum(usage_list, reported_list, do_accounting_summary, ja_task,
                                         intermediate ? USAGE_ATTR_CPU_ACCT : USAGE_ATTR_CPU, USAGE_ATTR_CPU, 0), delimiter,
          reporting_get_double_usage_sum(usage_list, reported_list, do_accounting_summary, ja_task,
                                         intermediate ? USAGE_ATTR_MEM_ACCT : USAGE_ATTR_MEM, USAGE_ATTR_MEM, 0), delimiter,
          reporting_get_double_usage_sum(usage_list, reported_list, do_accounting_summary, ja_task,
                                         intermediate ? USAGE_ATTR_IO_ACCT : USAGE_ATTR_IO, USAGE_ATTR_IO, 0), delimiter,
          none_string(category_str), delimiter,
          reporting_get_double_usage_sum(usage_list, reported_list, do_accounting_summary, ja_task,
                                         intermediate ? USAGE_ATTR_IOW_ACCT : USAGE_ATTR_IOW, USAGE_ATTR_IOW, 0), delimiter,
          none_string(pe_task_id), delimiter,
          reporting_get_double_usage_sum(usage_list, NULL, do_accounting_summary, ja_task,
                                         intermediate ? USAGE_ATTR_MAXVMEM_ACCT : USAGE_ATTR_MAXVMEM, USAGE_ATTR_MAXVMEM, 0), delimiter,
