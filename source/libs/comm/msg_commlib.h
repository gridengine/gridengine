...
#define MSG_CL_TCP_FW_CONNECTION_REFUSED                                      _MESSAGE(85008, _("connection refused"))
#define MSG_CL_TCP_FW_CANT_ASSIGN_ADDRESS                                     _MESSAGE(85009, _("can't assign requested address"))
#define MSG_CL_TCP_FW_SOCKET_ERROR_U                                          _MESSAGE(85010, _("socket error errno="U32CFormat""))
#define MSG_CL_TCP_FW_SELECT_ERROR                                            _MESSAGE(85011, _("select() returned: -1"))
#define MSG_CL_TCP_FW_CONNECT_ERROR_U                                         _MESSAGE(85012, _("connect error errno="U32CFormat""))
#define MSG_CL_TCP_FW_CONNECT_TIMEOUT                                         _MESSAGE(85013, _("connect timeout error"))
#define MSG_CL_TCP_FW_CANT_RESOLVE_SOURCE_HOST_S                              _MESSAGE(85014, _("can't resolve source hostname "SFQ""))
#define MSG_CL_TCP_FW_EMPTY_SOURCE_HOST                                       _MESSAGE(85015, _("got empty source host name from connected client"))
#define MSG_CL_TCP_FW_EMPTY_DESTINATION_HOST                                  _MESSAGE(85016, _("got empty destination host name from connected client"))
#define MSG_CL_TCP_FW_REMOTE_SOURCE_HOSTNAME_X_NOT_Y_SS                       _MESSAGE(85017, _("remote source host name "SFQ" is not equal to local resolved host name "SFQ""))
