...
#define MSG_FILE_NOOPEN_SS            _MESSAGE(23018, _("cant open file %s: %s\n"))
...
#define MSG_CONFIG_CONF_ERROROPENINGSPOOLFILE_SS    _MESSAGE(23021, _("error opening the configuration spool file "SFN": %s\n"))
...
#define MSG_CONFIG_CONF_GIDRANGELESSTHANNOTALLOWED_I  _MESSAGE(23025, _("gid range with minimum less than %d not allowed\n"))
...
#define MSG_ANSWER_SUBGROUPXINGROUPYNOTACCEPTED_SS _MESSAGE(23028, _("subgroup '%s' in group '%s' not accepted\n"))
#define MSG_ANSWER_HOSTXINGROUPYNOTACCEPTED_SS     _MESSAGE(23029, _("host '%s' in group '%s' not accepted\n"))
#define MSG_ANSWER_NOGUILTYSUBGROUPNAME_S    _MESSAGE(23030, _("'%s' is no guilty sub group name\n"))
#define MSG_ANSWER_NOGROUPNAMESPECIFIED      _MESSAGE(23031, _("no group name specified\n"))
#define MSG_ANSWER_XCANTBESUBGROUPOFITSELF_S _MESSAGE(23032, _("'%s' can't be it's own sub group\n"))
#define MSG_ANSWER_CANTGETSUBGROUPELEMX_S    _MESSAGE(23033, _("can't get sub group element '%s'\n"))
...
#define MSG_ANSER_CANTDELETEHGRPXREFERENCEDINUSERMAPPINGFORCLUSTERUSERY_SS _MESSAGE(23037, _("can't delete host group '%s' - referenced in user mapping for cluster user '%s'\n"))
#define MSG_ANSWER_HELPNOTALLOWEDINCONTEXT  _MESSAGE(23038, _("-help not allowed in this context\n"))
#define MSG_ANSWER_UNKOWNOPTIONX_S          _MESSAGE(23039, _("Unknown option %s"))
#define MSG_ANSWER_CANTPROCESSNULLLIST      _MESSAGE(23040, _("can't process NULL list"))
#define MSG_FILE_ERROROPENINGXY_SS          _MESSAGE(23041, _("error opening %s: %s\n"))
#define MSG_ANSWER_ERRORREADINGFROMFILEX_S  _MESSAGE(23042, _("error reading from file %s\n"))
...
#define MSG_FILE_ERROROPENFILEXFORWRITING_S _MESSAGE(23045, _("error opening file \"%s\" for writing\n"))
#define MSG_FILE_ERRORWRITETOFILEX_S        _MESSAGE(23046, _("error writing to file \"%s\"\n"))
#define MSG_ANSWER_ARGUMENTMISSINGFORX_S    _MESSAGE(23047, _("argument missing for \"%s\"\n"))
#define MSG_USER_INVALIDNAMEX_S                      _MESSAGE(23048, _("invalid user name \"%s\"\n"))
#define MSG_USER_NOHOMEDIRFORUSERX_S                 _MESSAGE(23049, _("missing home directory for user \"%s\"\n"))
#define MSG_ANSWER_GETUNIQUEHNFAILEDRESX_S  _MESSAGE(23050, _("getuniquehostname() failed resolving: %s\n"))
#define MSG_OBJ_UNABLE2FINDQ_S        _MESSAGE(23051, _("unable to find queue \"%s\"\n"))
...
** parse.c
*/
#define MSG_PARSE_XOPTIONMUSTHAVEARGUMENT_S _MESSAGE(23062, _("ERROR! %s option must have argument\n"))


/*
** parse_qlist.c
*/
#define MSG_PARSE_XOPTIONALREADYSETOVERWRITINGSETING_S        _MESSAGE(23063, _("\"%s\" option has already been set, overriding previous setting\n"))
#define MSG_PARSE_WORNGOBJLISTFORMATXSPECIFIEDTOYOPTION_SS    _MESSAGE(23064, _("ERROR! Wrong object list format \"%s\" specified to %s option\n"))
#define MSG_PARSE_DOPTIONMUSTHAVEFILEARGUMENT                 _MESSAGE(23065, _("ERROR! -d option must have file argument\n"))
#define MSG_PARSE_WRONGFIELDLISTFORMATXSPECIFIEDFORFOPTION_S  _MESSAGE(23066, _("ERROR! Wrong field list format \"%s\" specified to -f option\n"))


/*
** parse_qsub.c
*/
#define MSG_ANSWER_WRONGTIMEFORMATEXSPECIFIEDTOAOPTION_S  _MESSAGE(23068, _("ERROR! Wrong date/time format \"%s\" specified to -a option\n"))
...
#define MSG_ANSWER_WRONGCONTEXTLISTFORMATAC_S              _MESSAGE(23070, _("ERROR! Wrong context list format -ac \"%s\"\n"))
...
#define MSG_PARSE_WRONGCONTEXTLISTFORMATDC_S              _MESSAGE(23074, _("ERROR! Wrong context list format -dc \"%s\"\n"))
#define MSG_PARSE_DISPLAYOPTIONMUSTHAVEARGUMENT              _MESSAGE(23075, _("ERROR! -display option must have argument\n"))
#define MSG_PARSE_WRONGTIMEFORMATXSPECTODLOPTION_S             _MESSAGE(23076, _("ERROR! Wrong date/time format \"%s\" specified to -dl option\n"))
#define MSG_PARSE_WRONGPATHLISTFORMATXSPECTOEOPTION_S                 _MESSAGE(23077, _("ERROR! Wrong path list format \"%s\" specified to -e option\n"))
#define MSG_PARSE_UNKNOWNHOLDLISTXSPECTOHOPTION_S              _MESSAGE(23078, _("ERROR! Unknown hold list \"%s\" specified to -h option\n"))
#define MSG_PARSE_WRONGJIDHOLDLISTFORMATXSPECTOHOLDJIDOPTION_S              _MESSAGE(23079, _("ERROR! Wrong jid_hold list format \"%s\" specified to -hold_jid option\n"))
#define MSG_PARSE_INVALIDOPTIONARGUMENTJX_S              _MESSAGE(23080, _("invalid option argument \"-j %s\"\n"))
#define MSG_PARSE_WRONGRESOURCELISTFORMATXSPECTOLOPTION_S              _MESSAGE(23081, _("ERROR! Wrong resource list format \"%s\" specified to -l option\n"))
#define MSG_PARSE_WRONGMAILOPTIONSLISTFORMATXSPECTOMOPTION_S              _MESSAGE(23082, _("ERROR! Wrong mail options list format \"%s\" specified to -m option\n"))
#define MSG_PARSE_WRONGMAILLISTFORMATXSPECTOMOPTION_S              _MESSAGE(23083, _("ERROR! Wrong mail list format \"%s\" specified to -M option\n"))
...
#define MSG_PARSE_INVALIDOPTIONARGUMENTNOW_S              _MESSAGE(23086, _("invalid option argument \"-now %s\"\n"))
#define MSG_PARSE_WRONGSTDOUTPATHLISTFORMATXSPECTOOOPTION_S              _MESSAGE(23087, _("ERROR! Wrong stdout path list format \"%s\" specified to -o option\n"))
...
#define MSG_PARSE_WRONGDESTIDLISTFORMATXSPECTOQOPTION_S              _MESSAGE(23091, _("ERROR! Wrong destination identifier list format \"%s\" specified to -q option\n"))
...
#define MSG_PARSE_INVALIDOPTIONARGUMENTRX_S              _MESSAGE(23093, _("invalid option argument \"-r %s\"\n"))
#define MSG_PARSE_SCOPTIONMUSTHAVECONTEXTLISTARGUMENT              _MESSAGE(23094, _("ERROR! -sc option must have context list argument\n"))
#define MSG_PARSE_WRONGCONTEXTLISTFORMATSCX_S              _MESSAGE(23095, _("ERROR! Wrong context list format -sc \"%s\"\n"))
#define MSG_PARSE_SOPTIONMUSTHAVEPATHNAMEARGUMENT              _MESSAGE(23096, _("ERROR! -S option must have path_name argument\n"))
#define MSG_PARSE_WRONGSHELLLISTFORMATXSPECTOSOPTION_S              _MESSAGE(23097, _("ERROR! Wrong shell list format \"%s\" specified to -S option\n"))
...
#define MSG_PARSE_WRONGVARIABLELISTFORMATVORENVIRONMENTVARIABLENOTSET_S              _MESSAGE(23101, _("ERROR! Wrong variable list format -v \"%s\" or environment variable not set\n"))
#define MSG_PARSE_COULDNOTPARSEENVIRIONMENT              _MESSAGE(23102, _("ERROR! Could not parse environment\n"))
#define MSG_PARSE_INVALIDOPTIONARGUMENTWX_S              _MESSAGE(23103, _("invalid option argument \"-w %s\"\n"))
#define MSG_PARSE_ATSIGNOPTIONMUSTHAVEFILEARGUMENT       _MESSAGE(23104, _("ERROR! -@ option must have file argument\n"))
#define MSG_PARSE_INVALIDOPTIONARGUMENTX_S              _MESSAGE(23105, _("ERROR! invalid option argument \"%s\"\n"))
...
#define MSG_PARSE_WRONGJOBIDLISTFORMATXSPECIFIED_S              _MESSAGE(23108, _("ERROR! Wrong job id list format \"%s\" specified\n"))
...
** parse_qconf.c
*/
#define MSG_QCONF_CANTCHANGEQUEUENAME_S           _MESSAGE(23110, _("%s: cannot change queuename\n"))
#define MSG_QCONF_CANTCHANGEHOSTNAME_S           _MESSAGE(23111, _("%s: cannot change hostname\n") )  
...
#define MSG_EXEC_XISNOEXECHOST_S               _MESSAGE(23116, _("%s is no exec host\n"))
#define MSG_EXEC_ADDEDHOSTXTOEXECHOSTLIST_S    _MESSAGE(23117, _("added host %s to exec host list\n"))
...
#define MSG_TREE_CANTADDNODEXISNONUNIQUE_S     _MESSAGE(23123, _("Could not add node %s to sharetree due to non-unique path\n"))
#define MSG_TREE_SETTING                       _MESSAGE(23124, _("setting "))
#define MSG_TREE_REMOVING                      _MESSAGE(23125, _("removing ") ) 
#define MSG_ANSWER_XISNOTVALIDSEENODESHARESLIST_S _MESSAGE(23126, _("%s is not a valid argument, see node_shares_list format\n"))
...
#define MSG_ANSWER_NOLISTNAMEPROVIDEDTOAUX_S   _MESSAGE(23129, _("no list_name provided to \"-au %s\""))
#define MSG_ANSWER_NOLISTNAMEPROVIDEDTODUX_S   _MESSAGE(23130, _("no list_name provided to \"-du %s\""))
...
#define MSG_ANSWER_XISNOTAVALIDOPTIONY_SU      _MESSAGE(23133, _("\"%s\" is not a valid option " U32CFormat "\n"))
#define MSG_COMPLEX_NEEDACOMPLEXNAME           _MESSAGE(23134, _("Need a complex Name"))
#define MSG_CALENDAR_XISNOTACALENDAR_S         _MESSAGE(23135, _("%s is not a calendar\n"))
#define MSG_CKPT_XISNOTCHKPINTERFACEDEF_S      _MESSAGE(23136, _("%s is not a checkpointing interface definition\n"))
#define MSG_EXEC_XISNOTANEXECUTIONHOST_S       _MESSAGE(23137, _("%s is not an execution host\n"))
#define MSG_EXEC_HOSTENTRYOFXCHANGEDINEXECLIST_S     _MESSAGE(23138, _("changed entry of host %s in execution host list\n"))
#define MSG_PARALLEL_XNOTAPARALLELEVIRONMENT_S     _MESSAGE(23139, _("%s is not a parallel environment\n"))
#define MSG_QUEUE_XISNOTAQUEUENAME_S           _MESSAGE(23140, _("%s is not a queuename\n"))
#define MSG_QUEUE_UNABLETOWRITEOLDQUEUE        _MESSAGE(23141, _("unable to write old queue"))
#define MSG_ANSWER_MISSINGFILENAMEASOPTIONARG_S   _MESSAGE(23142, _("%s: missing filename as option argument\n"))
#define MSG_QCONF_XISNOTAOBJECTATTRIB_SSS         _MESSAGE(23143, _("%s: \"%s\" is not a %s attribute\n"))
#define MSG_QCONF_XISNOTAQUEUEATTRIB_SS           _MESSAGE(23144, _("%s: \"%s\" is not a queue attribute\n"))
#define MSG_QCONF_XISNOTAEXECHOSTATTRIB_SS           _MESSAGE(23145, _("%s: \"%s\" is not a exec host attribute\n"))
#define MSG_QCONF_CANTCHANGEOBJECTNAME_SS         _MESSAGE(23146, _("%s: cannot change %s\n"))
#define MSG_QCONF_INTERNALFAILURE_S               _MESSAGE(23147, _("%s: internal failure\n"))
#define MSG_QCONF_MQATTR_MISSINGOBJECTLIST_S       _MESSAGE(23148, _("%s: missing object list\n"))
#define MSG_QCONF_MQATTR_MISSINGQUEUELIST_S       _MESSAGE(23149, _("%s: missing queue list\n"))
#define MSG_QCONF_MQATTR_MISSINGHOSTLIST_S       _MESSAGE(23150, _("%s: missing host list\n") )        
#define MSG_SCHEDD_CHANGEDSCHEDULERCONFIGURATION  _MESSAGE(23151, _("changed scheduler configuration\n"))
#define MSG_USER_XISNOKNOWNUSER_S                 _MESSAGE(23152, _("%s is not known as user\n"))
#define MSG_PROJECT_XISNOKNWOWNPROJECT_S          _MESSAGE(23153, _("%s is not known as project\n"))
#define MSG_ANSWER_NEEDHOSTNAMETODELLOCALCONFIG     _MESSAGE(23154, _("Need hostname to delete local configuration\n"))
#define MSG_ANSWER_INVALIDOPTIONARGX_S            _MESSAGE(23155, _("invalid option argument \"%s\""))
#define MSG_SRC_X_HELP_USAGE_S                    _MESSAGE(23156, _("Usage: %s -help\n"))
#define MSG_FILE_EDITFILEXDOESNOTEXIST_S          _MESSAGE(23157, _("edit file %s does not exist"))
#define MSG_QCONF_EDITOREXITEDWITHERROR_I         _MESSAGE(23158, _("editor exited with error %d"))
#define MSG_QCONF_EDITFILEXNOLONGEREXISTS_S       _MESSAGE(23159, _("edit file %s no longer exists"))
#define MSG_QCONF_EDITORWASTERMINATEDBYSIGX_I     _MESSAGE(23160, _("editor was terminated by a signal %d\n"))
#define MSG_QCONF_CANTSTARTEDITORX_S              _MESSAGE(23161, _("can't start editor %s"))
#define MSG_QCONF_XADDEDTOYLIST_SS                _MESSAGE(23162, _("%s added to %s list\n"))
#define MSG_FILE_CANTCREATETEMPFILE               _MESSAGE(23163, _("could not generate temporary filename\n"))
#define MSG_QCONF_CANTREADCONFIG_S                _MESSAGE(23164, _("can't read configuration: %s\n"))
#define MSG_QCONF_CANTREADX_S                     _MESSAGE(23165, _("cant read %s\n"))
#define MSG_QCONF_CANTREADSHARETREEX_S            _MESSAGE(23166, _("cant read sharetree: %s\n"))
#define MSG_QCONF_NOXDEFINED_S                    _MESSAGE(23167, _("no %s defined\n"))
...
#define MSG_QCONF_XISNOVALIDCOMPLEXNAME_S         _MESSAGE(23170, _("%s is no valid complex name\n"))
#define MSG_ANSWER_MALFORMEDREQUEST               _MESSAGE(23171, _("malformed request\n"))
#define MSG_ANSWER_COMPLEXXALREADYEXISTS_S        _MESSAGE(23172, _("complex %s already exists\n"))
#define MSG_ANSWER_USERMAPENTRYALREADYEXISTS_S    _MESSAGE(23173, _("user mapping for %s already exists\n"))
#define MSG_ANSWER_HOSTGROUPENTRYALLREADYEXISTS_S _MESSAGE(23174, _("host group '%s' already exists\n"))
#define MSG_ANSWER_CLUSTERUNAMEXDIFFFROMY_SS      _MESSAGE(23175, _("\"cluster_user\" name entry '%s' does not match filename '%s'\n"))
#define MSG_UM_NOCLUSTERUSERENTRYINFILEX_S        _MESSAGE(23176, _("no \"cluster_user\" name entry in file '%s'\n"))
#define MSG_ANSWER_HOSTGROUPNAMEXDIFFFROMY_SS     _MESSAGE(23177, _("\"group_name\" entry '%s' does not match filename '%s'\n"))
#define MSG_HGRP_NOHOSTGROUPENTRYINFILEX_S        _MESSAGE(23178, _("no \"group_name\" name entry in file '%s'\n"))
#define MSG_ANSWER_UNKNOWNHOSTORGROUPNAME_S       _MESSAGE(23179, _("unknown host or group name '%s'\n"))
#define MSG_ANSWER_UNKNOWNHOSTNAME_S              _MESSAGE(23180, _("unknown host name '%s'\n"))
#define MSG_ANSWER_UNKNOWNGROUPNAME_S             _MESSAGE(23181, _("unknown group name '%s'\n"))
#define MSG_ANSWER_SUBGROUPHASNOSUPERGROUP_SS      _MESSAGE(23182, _("subgroup '%s' has no supergroup '%s'\n"))
#define MSG_ANSWER_SUBGROUPXHASLINKTOGROUPY_SS       _MESSAGE(23183, _("sub group '%s' has sub group link to group '%s' (deadlock)\n"))
#define MSG_ANSWER_SUPERGROUPHASNOSUBGROUP_SS      _MESSAGE(23184, _("supergroup '%s' has no subgroup '%s'\n"))
#define MSG_ANSWER_CLUSTERUNAMEXNOTAMBIGUOUSMAPFORYATZ_SSS _MESSAGE(23185, _("cluster_user name entry '%s' has not ambiguous mappings for '%s' at '%s'\n"))
#define MSG_ANSWER_DUPLICATEDMAPPINGENTRY_SSS     _MESSAGE(23186, _("mapping entry as user '%s' from '%s' already exists for cluster user '%s'\n"))
#define MSG_ANSWER_IGNORINGMAPPINGFOR_S           _MESSAGE(23187, _("usermapping for '%s' not accepted\n"))
#define MSG_ANSWER_IGNORINGHOSTGROUP_S            _MESSAGE(23188, _("host group list '%s' not accepted\n"))
#define MSG_ANSWER_USERMAPENTRYXNOTFOUND_S        _MESSAGE(23189, _("user mapping entry for user '%s' not found\n"))
#define MSG_ANSWER_HOSTGROUPENTRYXNOTFOUND_S      _MESSAGE(23190, _("host group entry for group '%s' not found\n"))
#define MSG_ANSWER_COMPLEXXDOESNOTEXIST_S         _MESSAGE(23191, _("complex %s does not exist.\n"))
...
#define MSG_ANSWER_XYCOMPLEXLIST_SS               _MESSAGE(23195, _("%s %s complex list\n"))
#define MSG_FILE_ERRORWRITINGUSERSETTOFILE        _MESSAGE(23196, _("error writing userset to file\n"))
#define MSG_FILE_ERRORREADINGUSERSETFROMFILE_S    _MESSAGE(23197, _("error reading userset from file %s\n"))
#define MSG_COMPLEX_COMPLEXXNOTDEFINED_S          _MESSAGE(23198, _("complex %s not defined\n"))
#define MSG_ERROR_USERXNOTDEFINED_S               _MESSAGE(23199, _("user %s not defined\n"))
#define MSG_ERROR_GROUPXNOTDEFINED_S              _MESSAGE(23200, _("host group '%s' is not defined\n"))
#define MSG_ANSWER_CONFIGXNOTDEFINED_S            _MESSAGE(23201, _("configuration %s not defined\n"))
#define MSG_ANSWER_CONFIGXALREADYEXISTS_S         _MESSAGE(23202, _("configuration %s already exists\n"))
#define MSG_ANSWER_CONFIGXDOESNOTEXIST_S          _MESSAGE(23203, _("configuration %s does not exist\n"))
...
#define MSG_ANSWER_ERRORREADINGCONFIGFROMFILEX_S  _MESSAGE(23206, _("error reading configuration from file %s\n"))
#define MSG_ANSWER_DENIEDHOSTXISNOADMINHOST_S     _MESSAGE(23207, _("denied: host \"%s\" is no admin host\n"))


/*
** sge_sharetree.c
*/
#define MSG_TREE_UNABLETOLACATEXINSHARETREE_S     _MESSAGE(23208, _("Unable to locate %s in sharetree\n"))
...
#define MSG_SCHEDCONF_CANTOPENSCHEDULERCONFIGURATIONFILE_SS    _MESSAGE(23226, _("cant open scheduler configuration file \"%s\": %s\n"))
#define MSG_SCHEDCONF_INVALIDVALUEXFORQUEUESORTMETHOD_S    _MESSAGE(23227, _("invalid value \"%s\" for queue_sort_method"))
...
#define MSG_PARSE_CANTPARSECPLX_S     _MESSAGE(23247, _("parse error in file %s\n"))
#define MSG_PARSE_CANTPARSECPLX_SI    _MESSAGE(23248, _("parse error in file %s in line %d\n"))
#define MSG_PARSE_INVALIDCPLXTYPE_SS    _MESSAGE(23249, _("parse error in file %s, unknown type %s\n"))
#define MSG_PARSE_INVALIDCPLXRELOP_SS   _MESSAGE(23250, _("parse error in file %s, invalid relation operator %s\n"))
#define MSG_PARSE_INVALIDCPLXCONSUM_SSS _MESSAGE(23251, _("error in file %s: attribute %s may not be consumable because it is of type %s\n"))
#define MSG_PARSE_INVALIDCPLXENTRY_SSS  _MESSAGE(23252, _("parse error in file %s, invalid %s entry %s\n"))
#define MSG_PARSE_INVALIDCPLXREQ_SS     _MESSAGE(23253, _("parse error in file %s, invalid requestable entry %s\n"))
...
#define MSG_CPLX_WRONGTYPE_SSS        _MESSAGE(23256, _("wrong type in \"%s=%s\" - %s expected\n"))
...
** read_object.c
*/
#define MSG_MEMORY_CANTMALLOCBUFFERFORXOFFILEY_SS    _MESSAGE(23262, _("can't malloc buffer for %s of file \"%s\""))
#define MSG_FILE_CANTDETERMINESIZEFORXOFFILEY_SS    _MESSAGE(23263, _("can't determine size for %s of file \"%s\""))
...
** read_write_host.c
*/
#define MSG_FILE_ERRORWRITING_SS    _MESSAGE(23266, _("error writing %s, %s\n"))
...
** read_write_queue.c
*/
#define MSG_ANSWER_GETUNIQUEHNFAILEDRESX_SS  _MESSAGE(23269, _("getuniquehostname() failed resolving %s: %s\n"))
...
#define MSG_PROJECT_FOUNDPROJECTXTWICE_S    _MESSAGE(23271, _("found project %s twice"))
#define MSG_PROJECT_INVALIDPROJECTX_S    _MESSAGE(23272, _("invalid project %s"))
#define MSG_JOB_FOUNDJOBWITHWRONGKEY_S    _MESSAGE(23273, _("found job with wrong key \"%s\""))
...
** get_conf.c
*/
#define MSG_CONF_GETCONF_S            _MESSAGE(23276, _("getting configuration: %s"))
...
#define MSG_CONF_NOLOCAL_S            _MESSAGE(23279, _("local configuration %s not defined - using global configuration"))
...
#define MSG_CONF_NOREADCONF_IS        _MESSAGE(23283, _("Error %d reading configuration \"%s\"\n"))
#define MSG_CONF_NOMERGECONF_IS       _MESSAGE(23284, _("Error %d merging configuration \"%s\"\n"))


/*
** sge_conf.c
*/
#define MSG_GDI_USING_SS              _MESSAGE(23285, _("using \"%s\" for %s\n"))
