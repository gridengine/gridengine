...
LISTDEF(QU_Type)
   ...
   SGE_STRING(QU_full_name, CULL_PRIMARY_KEY | CULL_JGDI_RO)
   ...
   SGE_LIST(QU_projects, UP_Type, CULL_CONFIGURE | CULL_JGDI_RO)
   SGE_LIST(QU_xprojects, UP_Type, CULL_CONFIGURE | CULL_JGDI_RO)
