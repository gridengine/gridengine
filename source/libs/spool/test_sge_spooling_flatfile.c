...
int main(int argc, char *argv[])
{
   ...
   spool_flatfile_align_object(&answer_list, queue, fields);
   ...
   filepath = spool_flatfile_write_object(&answer_list, queue,
                                          &spool_flatfile_instruction_config,
   ...
   filepath = spool_flatfile_write_list(&answer_list, queue_list,
                                        &spool_flatfile_instruction_config_list,
   ...
   spool_flatfile_align_object(&answer_list, NULL, fields);
   spool_flatfile_align_object(&answer_list, queue, NULL);
