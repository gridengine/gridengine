...
#define MSG_KRB_KRBGETNEWAUTHCONFAILUREX_S               _MESSAGE(53015, _("krb_get_new_auth_con failure - %s"))
...
#define MSG_KRB_KRB5SNAMETOPRINCIPALFAILEDX_S            _MESSAGE(53040, _("krb5_sname_to_principal failed - %s\n"))
...
#define MSG_KRB_KRBGETNEWAUTHCONFAILUREX_S               _MESSAGE(53054, _("krb_get_new_auth_con failure - %s"))
#define MSG_KRB_APPENDELEMFAILUREX_I                     _MESSAGE(53055, _("lAppendElem failure - %d"))
#define MSG_KRB_KRBGETNEWAUTHCONFAILUREX_S               _MESSAGE(53056, _("krb_get_new_auth_con failure - %s"))
