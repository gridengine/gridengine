...
#define MSG_SCHEDD_INFO_CANNOTRUNLIRS                 _MESSAGE(47140, _("Jobs cannot run because exceeds limit in limitation rule sets")) 
...
#define MSG_SCHEDD_INFO_JOBDYNAMICALLIMIT             _MESSAGE(47141, _("Jobs dropped because of invalid dynamical limit")) 
