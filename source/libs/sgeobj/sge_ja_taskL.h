...
SLISTDEF(JAT_Type, Task)
   SGE_ULONG(JAT_task_number, CULL_HASH | CULL_UNIQUE)
   SGE_ULONG(JAT_status, CULL_DEFAULT)
   SGE_ULONG(JAT_start_time, CULL_DEFAULT)
   SGE_ULONG(JAT_end_time, CULL_DEFAULT)
   ...
   SGE_ULONG(JAT_pvm_ckpt_pid, CULL_DEFAULT)

   SGE_ULONG(JAT_pending_signal, CULL_DEFAULT)
   SGE_ULONG(JAT_pending_signal_delivery_time, CULL_DEFAULT)
   SGE_ULONG(JAT_pid, CULL_DEFAULT)
   SGE_STRING(JAT_osjobid, CULL_DEFAULT)
   SGE_LIST(JAT_usage_list, UA_Type, CULL_DEFAULT)

   SGE_LIST(JAT_scaled_usage_list, UA_Type, CULL_DEFAULT)  
   SGE_ULONG(JAT_fshare, CULL_DEFAULT)
   SGE_DOUBLE(JAT_ticket, CULL_DEFAULT)
   SGE_DOUBLE(JAT_oticket, CULL_DEFAULT)
   SGE_DOUBLE(JAT_dticket, CULL_DEFAULT)

   SGE_DOUBLE(JAT_fticket, CULL_DEFAULT)
   SGE_DOUBLE(JAT_sticket, CULL_DEFAULT)
