...
#define MARK(n) mark_argument_syntax(n)
   ...
   if (VALID_OPT(as_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_as_OPT_HOSTNAME , MSG_GDI_UTEXT_as_OPT_HOSTNAME);
   }

   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(astnode_OPT, me.who)) {
...
#endif  
   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(aus_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_AUSER , MSG_GDI_UTEXT_AUSER );
   }

   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(aprj_OPT, me.who)) {
   ...
   if (VALID_OPT(dhgrp_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_dhgrp_OPT, MSG_GDI_UTEXT_dhgrp_OPT);
   }

#endif /* __SGE_NO_USERMAPPING__ */

   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(dl_OPT, me.who)) {
   ...
   if (VALID_OPT(ds_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_ds_OPT_HOST_LIST, MSG_GDI_UTEXT_ds_OPT_HOST_LIST);
   }

   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(dstnode_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_DSTNODE_NODELIST, MSG_GDI_UTEXT_DSTNODE_NODELIST);
      MARK(OA_NODE_LIST);
      MARK(OA_NODE_PATH);
   }

   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(dstree_OPT, me.who)) {
   ...
   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(ext_OPT, me.who)) {
   ...
   if (VALID_OPT(h_OPT, me.who)) {
      if ((me.who == QALTER) || (me.who == QRESUB)  || 
          (me.who == QHOLD)  || (me.who == QRLS)) {
   ...
   if (VALID_OPT(msconf_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_msconf_OPT, MSG_GDI_UTEXT_msconf_OPT);
   }

   if (VALID_OPT(me_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_me_OPT_SERVER, MSG_GDI_UTEXT_me_OPT_SERVER);
   }

   if (VALID_OPT(meattr_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_meattr_OPT_ATTR_NAME_VALUE_HOST_LIST,
         MSG_GDI_UTEXT_meattr_OPT_ATTR_NAME_VALUE_HOST_LIST);
      MARK(OA_HOST_ID_LIST);
   }
   ...
   if (VALID_OPT(Meattr_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_Meattr_OPT_FNAME_HOST_LIST,
         MSG_GDI_UTEXT_Meattr_OPT_FNAME_HOST_LIST );
      MARK(OA_HOST_ID_LIST);
   }

#ifndef __SGE_NO_USERMAPPING__

   if (VALID_OPT(mhgrp_OPT, me.who)) {
   ...
   if (VALID_OPT(mqattr_OPT, me.who)) {
...
#endif
   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(mus_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_muser_OPT_USER, MSG_GDI_UTEXT_muser_OPT_USER);
   }

   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(mprj_OPT, me.who)) {
   ...
   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(mstnode_OPT, me.who)) {
   ...
   if (VALID_OPT(nostdin_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_nostdin_OPT, MSG_GDI_UTEXT_nostdin_OPT);
   }

   if (VALID_OPT(noshell_OPT, me.who)) {
   ...
   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(ot_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_ot_OPT_TICKETS, MSG_GDI_UTEXT_ot_OPT_TICKETS);
   }

   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(P_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_P_OPT_PROJECT_NAME, 
         MSG_GDI_UTEXT_P_OPT_PROJECT_NAME);
   }
   if (VALID_OPT(p_OPT, me.who)) {
      if (me.who == QSELECT || me.who == QSH || me.who == QLOGIN 
          || me.who == QRSH ||me.who == QSUB || me.who == QALTER) {
   ...
   if (VALID_OPT(s_OPT, me.who)) {
      if (me.who == QMASTER || me.who == EXECD || me.who == SCHEDD) { 
         usage_silent(fp);
      } else 
      if (me.who == QSELECT) {
...
#ifndef __SGE_NO_USERMAPPING__
   if (VALID_OPT(shgrp_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_shgrp_OPT, MSG_GDI_UTEXT_shgrp_OPT);
   }

   if (VALID_OPT(shgrpl_OPT, me.who)) {
   ...
   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(rsstnode_OPT, me.who)) {
   ...
   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(sstree_OPT, me.who)) {
...
#ifndef __SGE_NO_USERMAPPING__
   if (VALID_OPT(sumap_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_sumap_OPT, MSG_GDI_UTEXT_sumap_OPT);
   }

   if (VALID_OPT(sumapl_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_sumapl_OPT, MSG_GDI_UTEXT_sumapl_OPT);
   }
#endif
   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(sus_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_suser_OPT_USER, MSG_GDI_UTEXT_suser_OPT_USER);
      MARK(OA_USER_LIST);
   }

   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(sprj_OPT, me.who)) {
   ...
   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(susl_OPT, me.who)) {
      PRINTITD(MSG_GDI_USAGE_suserl_OPT, MSG_GDI_UTEXT_suserl_OPT);
   }

   if (feature_is_enabled(FEATURE_SGEEE) && VALID_OPT(sprjl_OPT, me.who)) {
   ...
   if (VALID_OPT(JQ_DEST_OPR, me.who)) {
