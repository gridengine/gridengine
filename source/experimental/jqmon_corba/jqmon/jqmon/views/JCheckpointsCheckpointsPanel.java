...
public class JCheckpointsCheckpointsPanel extends JPanel {

	protected static ResourceBundle messages  = null;
	CheckpointsTableModel checkpointsModel    = null;
	JTable            table       = null;
	JScrollPane       scrollPane  = null;
	JGridBagLayout    layout      = null;
	protected JDebug  debug       = null;
	
	public JCheckpointsCheckpointsPanel(JDebug d, JCheckpointList ckptList){	
		super();
	...
	protected void initGUI(JCheckpointList ckptList) {
		debug.DENTER("JCheckpointsCheckpointsPanel.initGUI");
		
		checkpointsModel  = new CheckpointsTableModel(ckptList);
      JTable table      = new JTable(checkpointsModel);
      scrollPane        = new JScrollPane(table);
		...
		layout.constrain(this, scrollPane, 1,1,1,1, GridBagConstraints.BOTH, 
	...
	public void setCheckpointList(JCheckpointList ckptList) {
		checkpointsModel.setCheckpointList(ckptList);
	}

	public void updateCheckpoint(int index) {
		checkpointsModel.updateCheckpoint(index);
	}	

	public void deleteCheckpoint(int index) {
		debug.DENTER("JCheckpointsCheckpointsPanel.deleteCheckpoint()"); 
      checkpointsModel.deleteCheckpoint(index);
		debug.DEXIT();
   }
