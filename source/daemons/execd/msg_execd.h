...
#define MSG_JOB_CANTFINDDIRXFORREAPINGJOBYZ_SUU _("can't find directory \"%s\" for reaping job "U32CFormat"."U32CFormat"")
#define MSG_JOB_CANTREADCONFIGFILEFORJOBXY_UU    _("can't read config file for job "U32CFormat"."U32CFormat"\n")
#define MSG_STATUS_ABNORMALTERMINATIONOFSHEPHERDFORJOBXY_UU    _("abnormal termination of shepherd for job " U32CFormat"." U32CFormat ": no \"exit_status\" file")
#define MSG_STATUS_ABNORMALTERMINATIONFOSHEPHERDFORJOBXYEXITSTATEFILEISEMPTY_UU    _("abnormal termination of shepherd for job " U32CFormat "." U32CFormat ": \"exit_status\" file is empty")
...
#define MSG_JOB_CANTREADERRORFILEFORJOBXY_UU    _("can't read error file for job "U32CFormat"."U32CFormat"\n")
#define MSG_JOB_CANTREADUSAGEFILEFORJOBXY_UU    _("can't read usage file for job "U32CFormat"."U32CFormat"")
#define MSG_JOB_WXDIEDTHROUGHSIGNALYZ_UUSI    _("job "U32CFormat"."U32CFormat" died through signal %s (%d)")
#define MSG_JOB_TASKVOFJOBWXDIEDTHROUGHSIGNALYZ_SUUSI    _("task \"%s\" of job "U32CFormat"."U32CFormat" died through signal %s (%d)")
#define MSG_JOB_CANTREADUSEDRESOURCESFORJOB    _("can't read used resources for job")
#define MSG_JOB_CANTOPENJOBPIDFILEFORJOBXY_UU    _("can't open \"job_pid\" file for job "U32CFormat"."U32CFormat"\n")
...
#define MSG_EXECD_NOADDGIDOPEN_SUUS   _("failed opening addgrpid file %s of job "U32CFormat"."U32CFormat": %s")
#define MSG_JOB_NOREGISTERPTF_UUS     _("failed registering job "U32CFormat"."U32CFormat" at ptf: %s")
#define MSG_EXECD_NOOSJOBIDOPEN_SUUS  _("failed opening os jobid file %s of job "U32CFormat"."U32CFormat": %s")
