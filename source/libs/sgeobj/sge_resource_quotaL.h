...
LISTDEF(RQR_Type)
 ...
 SGE_ULONG(RQR_level, CULL_DEFAULT | CULL_JGDI_RO) /* maintained by qmaster needed only in parallel scheduling for accumulating slots after queues were tagged */
LISTEND
