...
lListElem *execd_job_start_failure(lListElem *jep, lListElem *jatep, char *error_string, int general);
lListElem *execd_job_run_failure(lListElem *jep, lListElem *jatep, char *error_string, int general);
