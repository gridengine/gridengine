...
LISTDEF(SPA_Type)
   ...
   SGE_DOUBLE(SPA_argval_lDoubleT)
   SGE_ULONG(SPA_argval_lUlongT)
   SGE_LONG(SPA_argval_lLongT)
   SGE_CHAR(SPA_argval_lCharT)
   SGE_INT(SPA_argval_lIntT)
   SGE_STRING(SPA_argval_lStringT)
   SGE_LIST(SPA_argval_lListT)
LISTEND 
