 ...
 *
 */
public class ResourceLimitImpl implements ResourceLimit, Serializable {
     ...
     */
    public ResourceLimitImpl() {}
    
    /**
     * Create a new limit rule info object
     * @param limitRuleName  name of the limit rule
     */
    public ResourceLimitImpl(String name) {
        setName(name);
    }
     ...
     * @param limitRuleName  name of the limit rule
     */
    public ResourceLimitImpl(String name, String limitValue, String usageValue) {
        setName(name);
