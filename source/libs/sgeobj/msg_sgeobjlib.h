...
#define MSG_AR_EVENT_STATE_SOFT_ERROR            _MESSAGE(64503, _("SOFT ERROR OCCURED"))
#define MSG_AR_EVENT_STATE_HARD_ERROR            _MESSAGE(64504, _("HARD ERROR OCCURED"))
#define MSG_AR_EVENT_STATE_TERMINATED            _MESSAGE(64505, _("HARD ERROR OCCURED"))
#define MSG_AR_EVENT_STATE_UNKNOWN               _MESSAGE(64506, _("UNKNOWN"))
