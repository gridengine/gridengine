...
/*          } */
         ...
         token.setProperty(SUNTCP_DESKTOP_ATTR, xDisplayNum);
         ...
         if (token != null) {
            token.setProperty(SUNTCP_DESKTOP_ATTR, "::");
         }
      }
   }
   ...
   private void launchVNCServer(String uid, String home, String domain_name, 
      ...
      xDisplayNum = token.getProperty(SUNTCP_DESKTOP_ATTR);
   ...
   private void getxDisplayNum(String uid, String home, HttpServletRequest request, HttpServletResponse response) 
      ...
      String xDisplayNum = token.getProperty(SUNTCP_DESKTOP_ATTR);

      if (xDisplayNum == null)
         out.println("SSOToken property \"" + SUNTCP_DESKTOP_ATTR + "\" is null");
      else
         out.println("SSOToken property \"" + SUNTCP_DESKTOP_ATTR + "\" is \"" + xDisplayNum + "\"");
   }
   ...
   private void htmlHeader(PrintWriter page, String title, String headInfo) {
      ...
      page.println("<tr><td bgcolor=666699><font color=FFFFFF><b>SunTCP "
