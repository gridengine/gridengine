 ...
 ************************************************************************/
/*___INFO__MARK_END__*/
// GuiTools.cpp : Legt die Initialisierungsroutinen für die DLL fest.
//
...
static AFX_EXTENSION_MODULE GuiToolsDLL = { NULL, NULL };
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
	...
	{
		TRACE0("GUITOOLS.DLL Initializing!\n");
		
		// One-Time-Initialisierung der Erweiterungs-DLL
		if (!AfxInitExtensionModule(GuiToolsDLL, hInstance))
			return 0;
		...
		new CDynLinkLibrary(GuiToolsDLL);
	}
	else if (dwReason == DLL_PROCESS_DETACH)
	{
		TRACE0("GUITOOLS.DLL Terminating!\n");
		// Bibliothek vor dem Aufruf der Destruktoren schließen
		AfxTermExtensionModule(GuiToolsDLL);
	}
	return 1;   // OK
}
