...
#define MSG_SHEPHERD_VSHEPHERDOFJOBWXDIEDTHROUGHSIGNALYZ_SUUSI    _MESSAGE(29011, _("%sshepherd of job "U32CFormat"."U32CFormat" died through signal %s= %d"))
#define MSG_SHEPHERD_WSHEPHERDOFJOBXYEXITEDWITHSTATUSZ_SUUI    _MESSAGE(29012, _("%sshepherd of job "U32CFormat"."U32CFormat" exited with exit status = %d\n"))
...
#define MSG_STATUS_LOADSENSORDIEDWITHSIGNALXY_SI    _MESSAGE(29014, _("load sensor died through signal %s= %d"))
#define MSG_STATUS_LOADSENSOREXITEDWITHEXITSTATUS_I    _MESSAGE(29015, _("load sensor exited with exit status = %d\n"))
#define MSG_STATUS_MAILERDIEDTHROUGHSIGNALXY_SI    _MESSAGE(29016, _("mailer died through signal %s = %d"))
#define MSG_STATUS_MAILEREXITEDWITHEXITSTATUS_I    _MESSAGE(29017, _("mailer exited with exit status = %d\n"))
#define MSG_JOB_REAPINGJOBXPTFCOMPLAINSY_US    _MESSAGE(29018, _("reaping job \""U32CFormat"\" ptf complains: %s"))
...
#define MSG_JOB_WXDIEDTHROUGHSIGNALYZ_SSI    _MESSAGE(29029, _("job "SFN" died through signal %s (%d)"))
...
#define MSG_SHEPHERD_PROBLEMSAFTERSTART_DS _MESSAGE(29043, _("problems after job start \""U32CFormat"\": %s"))
...
#define MSG_SHEPHERD_SHEPHERDFORJOBXHASPIDYANDISZALIVE_SUS    _MESSAGE(29056, _("shepherd for job %s has pid \""pid_t_fmt"\" and is %s alive\n"))
...
#define MSG_JOB_TICKETPASS2PTF_IS     _MESSAGE(29097, _("passing %d new tickets ptf complains: %s"))


/*
** exec_job.c
*/
#define MSG_FILE_RMDIR_SS             _MESSAGE(29098, _("can't remove directory \"%s\": %s\n"))
#define MSG_FILE_CREATEDIRDEL_SS      _MESSAGE(29099, _("can't create directory %s after deletion: %s"))
#define MSG_FILE_CREATEDIR_SS         _MESSAGE(29100, _("can't create directory %s: %s"))
...
#define MSG_EXECD_NOSHEPHERD_SSS      _MESSAGE(29108, _("unable to find shepherd executable neither in architecture directory %s nor in %s: %s"))
#define MSG_EXECD_NOSHEPHERDWRAP_SS   _MESSAGE(29109, _("unable to find shepherd wrapper command %s: %s"))
#define MSG_DCE_NOSHEPHERDWRAP_SS     _MESSAGE(29110, _("unable to find DCE shepherd wrapper command %s: %s"))
#define MSG_EXECD_NOCOSHEPHERD_SSS    _MESSAGE(29111, _("unable to find coshepherd executable neither in architecture directory %s nor in %s: %s"))
...
#define MSG_EXECD_NOCREATETOKENFILE_S _MESSAGE(29113, _("can't create token file: %s"))
#define MSG_EXECD_TOKENZERO           _MESSAGE(29114, _("AFS token does not exist or has zero length"))
#define MSG_EXECD_NOWRITETOKEN_S      _MESSAGE(29115, _("can't write token to token file: %s"))
...
#define MSG_FILE_CHDIR_SS             _MESSAGE(29118, _("can't change dir to %s: %s"))
#define MSG_EXECD_NOFORK_S            _MESSAGE(29119, _("fork failed: %s"))
#define MSG_EXECD_NOSTARTSHEPHERD     _MESSAGE(29120, _("unable to start shepherd process"))
#define MSG_EXECD_NOWHERE4GDIL_S        _MESSAGE(29121, _("cannot build where for %s\n"))
...
#define MSG_EXECD_NOADDGIDOPEN_SSS   _MESSAGE(29130, _("failed opening addgrpid file %s of job %s: %s"))
#define MSG_JOB_NOREGISTERPTF_SS     _MESSAGE(29131, _("failed registering job %s at ptf: %s"))
#define MSG_EXECD_NOOSJOBIDOPEN_SSS  _MESSAGE(29132, _("failed opening os jobid file %s of job %s: %s"))
