 ...
 * $Id: Xpm.c,v 1.1.1.1.26.1 2005/05/23 14:10:47 andre Exp $
 * 
 ...
 *
 * $Log: Xpm.c,v $
 * Revision 1.1.1.1.26.1  2005/05/23 14:10:47  andre
 * AA-2005-05-23-1: Bugfix:    Have the Queue Instances tab within Qmon display queues in alphabetical order (like 5.3 did with the queue tab)
 *                  Issue:     1602
 *                  Changed:   qmon
 *                  Review:    CR
 *
