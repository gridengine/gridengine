...
#define MSG_ATTR_MISSINGCHAR_S         _MESSAGE(64222, _("Missing \'"SFN"\' character\n"))
#define MSG_ATTR_MISSINGCHAR_SS        _MESSAGE(64223, _("Missing \'"SFN"\' character (..."SFQ"...)\n"))
#define MSG_ATTR_EQUALSIGNEXPRECTED    _MESSAGE(64224, _("\'=\' has to sepatate host or group from value\n"))
#define MSG_ATTR_INVALIDHNAME_S        _MESSAGE(64225, _("Invalid host/group name "SFQ"\n"))
...
#define MSG_QINSTANCE_NSUSPALARM       _MESSAGE(64245, _("vo suspend alarm"))
...
#define MSG_ATTRIB_PARSATTRFAILED_SS         _MESSAGE(64264, _("failed parsing attribute "SFQ": "SFN"\n"))
#define MSG_OBJECT_NO_LIST_TO_MOD_TYPE_SI    _MESSAGE(64265, _("%s: has no master list to modify %d\n"))
#define MSG_INVALID_CENTRY_PARSE_URGENCY_SS  _MESSAGE(64266, _("The following error occoured for complex "SFQ", while parsing the urgency value: "SFQ"\n"))
