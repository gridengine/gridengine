...
/**
 * Wrapper containing the parameters required
 * by job submission
 *
 ...
 *
 */
public class ComputeInfoParams
  implements java.io.Serializable
{
  ...
  public ComputeInfoParams(ComputeInfoEntry cie)
  {
    computeParams = cie;
  }
                           ...
                           int tilingFactor)
  {
    computeParams = new ComputeInfoEntry(manufacturer,
					 ...
					 osRev,
					 osArch,
					 new Integer(processCount),
					 new Integer(tilingFactor));
  }

  public ComputeInfoEntry getComputeInfoEntry()
  {
