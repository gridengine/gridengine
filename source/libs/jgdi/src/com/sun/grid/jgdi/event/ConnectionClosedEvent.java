 ...
 * if the jmx connection has been closed
 */
public class ConnectionClosedEvent extends Event implements java.io.Serializable {
     ...
     */
    public ConnectionClosedEvent(long timestamp, int eventId) {
