 ...
 * sge_event.c
 */
#define MSG_EVENT_JOBXFINISH_US                    _MESSAGE(64084, _(sge_U32CFormat". EVENT JOB "SFN" FINISH"))
#define MSG_EVENT_ADDJATASK_US                     _MESSAGE(64085, _(sge_U32CFormat". EVENT ADD JATASK "SFN""))
#define MSG_EVENT_DELJOB_US                        _MESSAGE(64086, _(sge_U32CFormat". EVENT DEL JOB "SFN))
#define MSG_EVENT_ADDJOB_US                        _MESSAGE(64087, _(sge_U32CFormat". EVENT ADD JOB "SFN))
#define MSG_EVENT_MODJOB_US                        _MESSAGE(64088, _(sge_U32CFormat". EVENT MOD JOB "SFN))
#define MSG_EVENT_JOBLISTXELEMENTS_UI              _MESSAGE(64089, _(sge_U32CFormat". EVENT JOB LIST %d Elements"))
...
#define MSG_EVENT_MODSCHEDDPRIOOFJOBXTOY_USI       _MESSAGE(64094, _(sge_U32CFormat". EVENT MODIFY SCHEDULING PRIORITY OF JOB "SFN" TO %d"))
#define MSG_EVENT_JOBXUSAGE_US                     _MESSAGE(64095, _(sge_U32CFormat". EVENT JOB "SFN" USAGE"))
#define MSG_EVENT_JOBXFINALUSAGE_US                _MESSAGE(64096, _(sge_U32CFormat". EVENT JOB "SFN" FINAL USAGE"))
...
#define MSG_EVENT_DELJATASK_US                     _MESSAGE(64161, _(sge_U32CFormat". EVENT DEL JATASK "SFN""))
#define MSG_EVENT_MODJATASK_US                     _MESSAGE(64162, _(sge_U32CFormat". EVENT MOD JATASK "SFN""))
#define MSG_EVENT_ADDPETASK_US                     _MESSAGE(64163, _(sge_U32CFormat". EVENT ADD PETASK "SFN""))
#define MSG_EVENT_DELPETASK_US                     _MESSAGE(64164, _(sge_U32CFormat". EVENT DEL PETASK "SFN""))
...
#define MSG_OBJECT_ULONG_NULL            _MESSAGE(64313, _("object attribute "SFQ" may only be 0"))
#define MSG_OBJECT_DOUBLE_NULL            _MESSAGE(64314, _("object attribute "SFQ" may only be 0"))
#define MSG_OBJECT_STRING_NOT_NULL            _MESSAGE(64315, _("object attribute "SFQ" may not be NULL"))
#define MSG_OBJECT_VARIABLENAME_NOT_EMPTY            _MESSAGE(64316, _("variable names may not be empty"))

#define MSG_PATH_TOOLONG_I _MESSAGE(64320, _("a path or filename may not exceed %d characters"))
#define MSG_PATH_ALIAS_INVALID_PATH _MESSAGE(64321, _("paths may not be empty strings"))
#define MSG_HOSTNAME_NOT_EMPTY _MESSAGE(64322, _("hostnames may not be empty string"))
#define MSG_HOSTNAME_TOOLONG _MESSAGE(64323, _("hostnames too long"))

#define MSG_EVENT_INVALIDNAME _MESSAGE(64330, _("invalid event client name"))
#define MSG_EVENT_ONLYADMINMAYSTARTSPECIALEVC _MESSAGE(64331, _("only admin user or root may start special event clients"))
#define MSG_EVENT_INVALIDDTIME_II _MESSAGE(64332, _("invalid event delivery time %d. It has to be between 1 and %d"))
#define MSG_EVENT_FLUSHDELAYCANNOTBEGTDTIME _MESSAGE(64333, _("event flush delay may not be greater than event delivery time"))
#define MSG_EVENT_INVALIDBUSYHANDLING _MESSAGE(64334, _("invalid value for event client busy handling"))
#define MSG_EVENT_INVALIDSESSIONKEY _MESSAGE(64335, _("invalid session key for event client"))
#define MSG_EVENT_INVALIDEVENT _MESSAGE(64336, _("invalid event id in event client subscription"))
