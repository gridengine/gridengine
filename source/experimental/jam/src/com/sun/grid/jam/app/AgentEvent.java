...
/**
 * Event object passed to <code>AgentEventListenerInterface</code>
 * implementers via the latter's agentNotify method.
 *
 * @author Eric Sharakan
 * @version 1.3, 09/22/00
 * @see AgentEventListenerInterface
 */
public class AgentEvent
  extends EventObject
{
  private LookupCache serviceCache;
  private ServiceMatches services;
  ...
  public AgentEvent(Object source, LookupCache serviceCache,
