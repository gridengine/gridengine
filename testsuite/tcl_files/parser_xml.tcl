...
proc qstat_ext_xml_parse { output } {
   ...
   set jobtype1 "ext"
   set result1 [qstat_xml_jobid $node1 $jobtype1 output_xml]
   #puts $CHECK_OUTPUT "calling jobtype is  $jobtype1 ... \n"
   ...
   set jobtype2 "extpending"
   set result2 [qstat_xml_jobid $node121 $jobtype2 output_xml]
   #puts $CHECK_OUTPUT "second calling jobtype is  $jobtype2 ... \n"
...
#                                                             max. column:     |
#****** parser_xml/qstat_F_rerun_h_vmem_xml_parse() ******
#
#  NAME
#     qstat_F_rerun_h_vmem_xml_parse -- Generate XML output and return assoc array
#
#  SYNOPSIS
#     qstat_F_rerun_h_vmem__xml_parse { output }
#                     -- Generate XML output and return assoc array with
#                        entries jobid, prior, name, user, state, total_time,
#                        queue slots and task_id if needed. Pass XML info
#                        to proc qstat_xml_jobid which does the bulk of
...
proc qstat_F_rerun_h_vmem_xml_parse { output } {
   ...
   # Run now -xml command
   set XML [start_sge_bin  "qstat" "-F rerun,h_vmem -xml" ]
   ...
   set result1 [qstat_F_rerun_h_vmem_xml_queue $node1 output_xml]
...
proc qstat_xml_jobid { node121 jobtype output} {
   ...
   }  elseif { $jobtype == "extpending" } { ; # this is for listing qstat -ext pending jobs
   ...
   }  elseif { $jobtype == "ext" } { ; # this is for listing qstat -ext jobs
   ...
   foreach column $column_vars {
      ...
      # For colums "queue" and "master" we need to append rather than set
      ...
      ##puts $CHECK_OUTPUT "in first loop jobid is $jobid and column  $column is $xml_param  ... \n"   
   }
   ...
   while { 1 } {
      ...
      ##puts $CHECK_OUTPUT "$jobtype for jobid $next_jobid column_vars are $column_vars ... \n"
      ...
      foreach next_column $column_vars {
         ...
         ##puts $CHECK_OUTPUT "in second loop jobid is $next_jobid and \
                             column  $next_column is $next_xml_param  ... \n"        
...
#                                                             max. column:     |
#****** parser_xml/qstat_g_d_xml_parse() ******
#
#  NAME
#     qstat_g_d_xml_parse -- Generate XML output and return assoc array 
#
#  SYNOPSIS
#     qstat_g_d_xml_parse { output }
#                     -- Generate XML output and return assoc array with
#                        entries jobid, prior, name, user, state, total_time,
#                        queue slots and task_id if needed. Pass XML info
#                        to proc qstat_xml_jobid which does the bulk of
...
proc qstat_g_d_xml_parse { output } {
   ...
   # Run now -xml command
   set XML [start_sge_bin  "qstat" "-g d -xml" ]
...
#                                                             max. column:     |
#****** parser_xml/qstat_g_t_xml_parse() ******
#
#  NAME
#     qstat_g_t_xml_parse -- Generate XML output and return assoc array 
#
#  SYNOPSIS
#     qstat_g_t_xml_parse { output }
#                     -- Generate XML output and return assoc array with
#                        entries jobid, prior, name, user, state, total_time,
#                        queue slots and task_id if needed. Pass XML info
#                        to proc qstat_xml_jobid which does the bulk of
...
proc qstat_g_t_xml_parse { output } {
   ...
   # Run now -xml command
   set XML [start_sge_bin  "qstat" "-g t -xml" ]
