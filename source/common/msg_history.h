...
#define MSG_FILE_CANTOPENFILEX_S                               _MESSAGE(25005, _("can't open file "SFQ"\n"))
...
#define MSG_HISTORY_CANTFINDQUEUEVERSIONFORQUEUEXREFTOYZ_SSI    _MESSAGE(25022, _("can't find queue version for queue "SFQ" referring to "SFQ": %d"               ))
...
#define MSG_HISTORY_FINDCOMPLEXVERSIONBYNAMEERRORXRETRIEVENCOMPLEXVERSIONFORY_IS _MESSAGE(25026, _("find_complex_version_by_name: error %d retrieving complex version for "SFN"\n"))
...
#define MSG_HISTORY_FINDHOSTVERSIONBYNAMEERRORXRETRIEVINGHOSTVERSIONFORY_IS   _MESSAGE(25029, _("find_host_version_by_name: error %d retrieving host version for "SFN"\n"))
...
#define MSG_HISTORY_XPREPVERSSUBDIRFORQUEUEY_IS                      _MESSAGE(25051, _("%d preparing version subdir for queue "SFN"\n"))
#define MSG_HISTORY_XWRITINGTOVERSSUBDIRTHECONFIGFORQUEUEY_IS        _MESSAGE(25052, _("%d writing to version subdir the configuration for queue "SFN"\n"))
#define MSG_HISTORY_WRITEHOSTHISTORYERRORXPREPVERSSUBDIRFORHOSTY_IS  _MESSAGE(25053, _("write_host_history: error %d preparing version subdir for host "SFN"\n"))
#define MSG_HISTORY_WRITEHOSTHISTORYERRORXWRITINGTOVERSSUBDIRTHECONFIGFORHOSTY_IS  _MESSAGE(25054, _("write_host_history: error %d writing to version subdir the configuration for host "SFN"\n" ))
#define MSG_HISTORY_WRITECOMPLEXHISTORYERRORXPREPARINGVERSIONSUBIDRFORCOMPLEXY_IS  _MESSAGE(25055, _("write_complex_history: error %d preparing version subdir for complex "SFN"\n" ))
#define MSG_HISTORY_WRITECOMPLEXHISTORYERRORXWRITINGTOVERSIONSUBDIRTHECONFIGFORCOMPLEXY_IS  _MESSAGE(25056, _("write_complex_history: error %d writing to version subdir the configuration for complex "SFN"\n" ))
...
#define MSG_HISTORY_PREPAREVERSIONSUBDIRERRORXREADINGHISTSUBDIRY_IS  _MESSAGE(25060, _("prepare_version_subdir: error %d reading history subdirectory "SFN"\n"))
#define MSG_HISTORY_PREPAREVERSIONSUBDIRERRORXFINDINGVERSIONSUBDIRFOROBJY_IS  _MESSAGE(25061, _("prepare_version_subdir: error %d finding version subdir for object "SFN"\n"))
#define MSG_HISTORY_PREPAREVERSIONSUBDIRERRORXFINDVERSINSUBDIRFOROBJY_IS   _MESSAGE(25062, _("prepare_version_subdir: error %d finding version subdir for object "SFN"\n"))
...
#define MSG_HISTORY_COMPLEXSTRUCTUREREFTOXCANTBEASSEMBLEDY_SI  _MESSAGE(25077, _("complex structure referring to "SFN" can't be assembled(%d)\n"))
...
#define MSG_HISTORY_QUEUECONFIGFORXREFTOYCANTBEASSEMBLEDY_SSI  _MESSAGE(25079, _("queue configuration for queue "SFN" referring to "SFN" can't be assembled(%d)\n"))
#define MSG_HISTORY_HOSTCONFIGFORHOSTXREFTOYCANTBEASSEMBLEDYFORJOBZ_SSIU   _MESSAGE(25080, _("host configuration for host "SFN" referring to "SFN" can't be assembled(%d) for job " U32CFormat"\n"))
#define MSG_HISTORY_GLOBALHOSTCONFIGFORGLOBALHOSTXREFTOYCANTBEASSEMBLEDYFORJOBZ_SSID   _MESSAGE(25081, _("global_host configuration for global_host "SFN" referring to "SFN" can't be assembled(%d) for job " U32CFormat"\n"))
