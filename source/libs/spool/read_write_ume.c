...
const lListElem *ep 
   ...
   if (spool == 2) { 
     FPRINTF((fp,"# "SFQ"",MSG_UM_CONFIGTEXT1));
     FPRINTF((fp,"# "SFQ"",MSG_UM_CONFIGTEXT2));
     FPRINTF((fp,"# "SFQ"",MSG_UM_CONFIGTEXT3));
   }
   ...
   if (spool == 2) {
     FPRINTF((fp,"# "SFQ"",MSG_UM_CONFIGTEXT2));
     FPRINTF((fp,"# "SFQ"",MSG_UM_CONFIGTEXT4));
     FPRINTF((fp,"# "SFQ"",MSG_UM_CONFIGTEXT5));
     FPRINTF((fp,"# "SFQ"",MSG_UM_CONFIGTEXT2));
     FPRINTF((fp,"# "SFQ"",MSG_UM_CONFIGTEXT6));
   }    
