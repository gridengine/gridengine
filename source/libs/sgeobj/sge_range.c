...
*     boll comma_as_separator - use the format 1,2,3 instead of 1-2:3
*
*  RESULT
   ...
   if (string != NULL) {
      if (this_list != NULL) {
         ...
         for_each(range, this_list) {
            ...
            range_to_dstring(start, end, step, string, ignore_step, comma_as_separator);
         }
      } else {
