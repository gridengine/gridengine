...
public class CullDefinition {
   ...
   private Map cullObjectMap = new HashMap();
   private Map nameObjectMap = new HashMap();
   ...
   public int verify() {
      ...
      int errors = 0;
      Iterator iter = getObjectNames().iterator();
      while(iter.hasNext()) {
   ...
   public Set getNameSpaceNameSet() {
   ...
   public CullEnum getEnum(String name) {
      return (CullEnum)enumMap.get(name);
   }
}
