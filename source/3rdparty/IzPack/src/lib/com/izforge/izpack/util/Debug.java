...
public class Debug
{
     ...
     */
    public static String LOGFILE_PREFIX = "SGE_Gui-Installer_Log_";
    ...
    /**
     * LOGFILENAME = LOGFILE_PREFIX + <TimeStamp> + LOGFILE_EXTENSION
     */
    public static String LOGFILENAME = LOGFILE_PREFIX + generateTimeStamp() + LOGFILE_EXTENSION;
