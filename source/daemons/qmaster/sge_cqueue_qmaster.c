...
#if 0 /* core implementation for qconf -sick */
   /*
    * Warn about:
               ...
               if (is_hgroup_name(name)) {
                  if (strcmp(name, HOSTREF_DEFAULT)) {
                     ...
                     if (lGetNumberOfElem(add_hosts)) {
                        DPRINTF(("default value of "SFQ" is overwritten for "
                  ...
                  if (!href_list_has_member(used_hosts, name)) {
                     DPRINTF(("unused setting for attribute "SFQ
