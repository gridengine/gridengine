 ...
 */
public class QueueInstanceSummaryImpl implements QueueInstanceSummary {
   ...
   private List explainMessageList;
    ...
    */
   public void addJobs(List jobList) {
      ...
      if(!jobList.isEmpty()) {
         ...
         if(logger.isLoggable(Level.FINER)) {
            ...
            while(iter.hasNext()) {
               logger.finer("job " + iter.next() + " added");
            }
         }
      }
   }
   ...
   public void addExplainMessage(String message) {
      if (explainMessageList == null) {
         explainMessageList = new ArrayList();
      }
   ...
   public void addResource(String dom, String name, String value) {
      ...
      Map map = (Map)resourceMap.get(dom);
      if(map == null) {
         map = new HashMap();
