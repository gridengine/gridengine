...
public abstract class AddEvent extends ChangedObjectEvent implements java.io.Serializable {
     ...
     * @param objectType  type of the added object
     */
    public AddEvent(long timestamp, int eventId, Class objectType) {
        super(EventType.SGE_EMA_ADD, timestamp, eventId, objectType);
    }
