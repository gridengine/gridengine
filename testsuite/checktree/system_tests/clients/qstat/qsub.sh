...
qsub -o /dev/null -j y -N PARALLEL -q all.q -pe make 2 $SGE_ROOT/examples/jobs/sleeper.sh 10000
...
qsub -o /dev/null -j y -N AMD64 -q all.q@dt218-151 -t 1-5 $SGE_ROOT/examples/jobs/sleeper.sh 10000
