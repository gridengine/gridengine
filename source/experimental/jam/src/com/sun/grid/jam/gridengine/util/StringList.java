...
/**
 * This class is a representation of a list that holds String
 * objects.
 *
 * @version 1.1, 06/21/00
 *
  ...
  extends SGEList
{
  ...
  /**
   * Gets String object at a specified position.
   *
   * @param index - position of an element that should be returned
   *
   * @return String object at the position specified by index
   *
  ...
  {
    return (String)super.getElem(index);
  }

  //=========== setters ===============

  /**
   * Adds new String object into a list.
   *
   * @param str - String object to be added
   *
   * @see java.lang.String
