...
#else
   if (file_descriptor_settings_result == 1) {
      /* This is for USE_POLL */
      WARNING((SGE_EVENT, MSG_QMASTER_FD_USE_POLL_LARGER_THAN_LIMIT_U, sge_u32c(FD_SETSIZE)));
      WARNING((SGE_EVENT, MSG_QMASTER_FD_USE_POLL_COMPILE_MESSAGE1_U, sge_u32c(FD_SETSIZE - 20)));
   }
#endif
