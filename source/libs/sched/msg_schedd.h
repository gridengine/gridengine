...
#define MSG_SCHEDD_INFO_JOBINERROR_                   _MESSAGE(47073, _("Jobs dropped because of error state") )  
#define MSG_SCHEDD_INFO_JOBHOLD_                      _MESSAGE(47074, _("Jobs dropped because of hold state") )  
