...
** sge_follow.c
*/
#define MSG_JOB_IGNORE_DELETED_TASK_UU _MESSAGE(33013, _("ignoring obtained start order for deleted task: "U32CFormat"."U32CFormat"\n"))
...
#define MSG_JOB_ORDERDELINCOMPLETEJOB_UU  _MESSAGE(33042, _("scheduler tried to remove a incomplete job "U32CFormat"."U32CFormat))
...
#define MSG_JOB_PRIOSET_SSUI              _MESSAGE(33901, _(SFN"@"SFN" sets scheduling priority of job "U32CFormat" to %d\n"))
