...
#define MSG_PWD_READ_SGEPASSWD      _MESSAGE(57326,         _(SFN": can't read from sgepasswd file: %s (%d)\n"))
#define MSG_PWD_WRITE_SGEPASSWD     _MESSAGE(57327,         _(SFN": can't write to sgepasswd file: %s (%d)\n"))
#define MSG_PWD_CLOSE_SGEPASSWD     _MESSAGE(57328,         _(SFN": error closing sgepasswd file: %s (%d)\n"))
