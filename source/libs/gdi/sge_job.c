...
*
*  FUNCTION
*     Creates a unique key consisting of job_id, ja_task_id and pe_task_id.
*     This key can again be split into its components by a call to 
*     job_parse_key().
*
*  INPUTS
*     u_long32 job_id        - job id
...
*     u_long32 *job_id     - pointer to variable to contain the job_id
*     u_long32 *ja_task_id - pointer to variable to contain the ja_task_id
