...
LISTDEF(STN_Type)
   ...
   SGE_STRING(STN_name, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE | CULL_SPOOL | CULL_CONFIGURE)
   SGE_ULONG(STN_type, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE)        /* 960624 svd - changed to STN_type */
   SGE_ULONG(STN_id, CULL_DEFAULT | CULL_CONFIGURE)         /* Unique node id for storing to disk */
   SGE_ULONG(STN_shares, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE)
   SGE_LIST(STN_children, STN_Type, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE)
