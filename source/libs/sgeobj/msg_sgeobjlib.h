...
#define MSG_CONF_NR_DYNAMIC_EVENT_CLIENT_EXCEEDS_MAX_FILEDESCR_U _MESSAGE(64303, _("nr of dynamic event clients exceeds max file descriptor limit, setting MAX_DYN_EC="sge_U32CFormat))
#define MSG_CENTRY_QINOTALLOWED        _MESSAGE(64304, _("Queue instance names are not allowed in -l resource requests"))
#define MSG_OBJECT_VALUENOTULONG_S     _MESSAGE(64305, _(SFQ" is not an u_long32 value"))
#define MSG_CQUEUE_INVALIDDOMSETTING_SS _MESSAGE(64306, _("Did not modify "SFQ" for host group "SFQ" which does not exist."))
#define MSG_HGRP_INVALIDHOSTGROUPNAME_S   _MESSAGE(64307, _("host group name "SFQ" is not valid"))
#define MSG_WEIGHTFACTNONUMB_S         _MESSAGE(64308, _("\"load_formula\" uses "SFQ" as weighting factor (only numbers are allowed)"))
#define MSG_MULTIPLEWEIGHTFACT         _MESSAGE(64309, _("\"load_formula\" may not use multiple weighting factors"))
