...
LISTDEF(PE_Type)
   ...
   SGE_STRING_D(PE_name, CULL_PRIMARY_KEY | CULL_HASH | CULL_UNIQUE | CULL_SPOOL | CULL_CONFIGURE, "template")
   SGE_ULONG(PE_slots, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE)
   SGE_LIST(PE_user_list, US_Type, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE) 
   SGE_LIST(PE_xuser_list, US_Type, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE) 
   SGE_STRING_D(PE_start_proc_args, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE, "/bin/true")
   SGE_STRING_D(PE_stop_proc_args, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE, "/bin/true")
   SGE_STRING_D(PE_allocation_rule, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE, "$pe_slots")
   SGE_BOOL_D(PE_control_slaves, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE, "FALSE")
   SGE_BOOL_D(PE_job_is_first_task, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE, "TRUE")
   ...
   SGE_STRING_D(PE_urgency_slots, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE, "min")
#ifdef SGE_PQS_API
   SGE_STRING(PE_qsort_args, CULL_DEFAULT | CULL_SPOOL | CULL_CONFIGURE)
#endif
LISTEND 
