...
#define MSG_SHADOWD_CONTROLLEDSHUTDOWN_SSS  _MESSAGE(27003, _("controlled shutdown "SFN" "SFN" ("SFN")"))
#define MSG_SHADOWD_CONTROLLEDSHUTDOWN_SSSU _MESSAGE(27000, _("controlled shutdown "SFN" "SFN" ("SFN") (exit state = "sge_U32CFormat")"))
