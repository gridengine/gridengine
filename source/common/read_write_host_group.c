...
lListElem *ep 
   ...
   if (spool == 2) { 
     FPRINTF((fp,MSG_HOSTGROUP_CONFIGTEXT1));
     FPRINTF((fp,MSG_HOSTGROUP_CONFIGTEXT2));
     FPRINTF((fp,MSG_HOSTGROUP_CONFIGTEXT3));
   }
   ...
   if (spool == 2) {
     FPRINTF((fp,MSG_HOSTGROUP_CONFIGTEXT2));
     FPRINTF((fp,MSG_HOSTGROUP_CONFIGTEXT4));
     FPRINTF((fp,MSG_HOSTGROUP_CONFIGTEXT5));
     FPRINTF((fp,MSG_HOSTGROUP_CONFIGTEXT6));
     FPRINTF((fp,MSG_HOSTGROUP_CONFIGTEXT2));
   }    
