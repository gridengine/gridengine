...
#define MSG_CULL_NOTENOUGHMEMORYFORPACKINGXY_SS          _MESSAGE(41002, _("not enough memory for packing %s \"%s\"\n"))
#define MSG_CULL_NOTENOUGHMEMORYFORUNPACKINGXY_SS        _MESSAGE(41003, _("not enough memory for unpacking %s \"%s\"\n"))
#define MSG_CULL_FORMATERRORWHILEPACKINGXY_SS            _MESSAGE(41004, _("format error while packing %s \"%s\"\n"))
#define MSG_CULL_UNEXPECTEDERRORWHILEPACKINGXY_SS        _MESSAGE(41005, _("unexpected error while packing %s \"%s\"\n"))
#define MSG_CULL_UNEXPECTEDERRORWHILEUNPACKINGXY_SS      _MESSAGE(41006, _("unexpected error while unpacking %s \"%s\"\n"))
#define MSG_CULL_FORMATERRORWHILEUNPACKINGXY_SS          _MESSAGE(41007, _("format error while unpacking %s \"%s\"\n"))
#define MSG_CULL_CANTOPENXFORWRITINGOFYZ_SSS             _MESSAGE(41008, _("can't open %s for writing of %s: %s"))
#define MSG_CULL_CANTWRITEXTOFILEY_SS                    _MESSAGE(41009, _("can't write %s to file %s"))
#define MSG_CULL_CANTREADXFROMFILEY_SS                   _MESSAGE(41010, _("can't read %s from file %s"))
#define MSG_CULL_CANTGETFILESTATFORXFILEY_SS             _MESSAGE(41011, _("can't get file stat for %s file \"%s\""))
#define MSG_CULL_XFILEYHASZEROSIYE_SS                    _MESSAGE(41012, _("%s file \"%s\" has zero size"))
#define MSG_CULL_ERRORREADINGXINFILEY_SS                 _MESSAGE(41013, _("error reading %s in file %s"))
#define MSG_CULL_BADARGUMENTWHILEUNPACKINGXY_SS          _MESSAGE(41014, _("bad argument error while unpacking %s \"%s\"\n"))
...
*/ 
#define MSG_CULL_POINTER_GETLISTREF_NULLELEMENTFORX_S    _MESSAGE(41018, _("!!!!!!!!!! lGetListRef(): got NULL element for %s !!!!!!!!!!\n"))
#define MSG_CULL_POINTER_GETULONG_NULLELEMENTFORX_S      _MESSAGE(41019, _("!!!!!!!!!! lGetUlong(): got NULL element for %s !!!!!!!!!!\n"))
#define MSG_CULL_POINTER_GETSTRING_NULLELEMENTFORX_S     _MESSAGE(41020, _("!!!!!!!!!! lGetString(): got NULL element for %s !!!!!!!!!!\n"))
#define MSG_CULL_POINTER_GETHOST_NULLELEMENTFORX_S       _MESSAGE(41021, _("!!!!!!!!!! lGetHost(): got NULL element for %s !!!!!!!!!!\n"))
#define MSG_CULL_POINTER_GETLIST_NULLELEMENTFORX_S       _MESSAGE(41022, _("!!!!!!!!!! lGetList(): got NULL element for %s !!!!!!!!!!\n"))
#define MSG_CULL_GETLISTREF_XNOTFOUNDINELEMENT_S         _MESSAGE(41023, _("!!!!!!!!!! lGetListRef(): %s not found in element !!!!!!!!!!\n"))
#define MSG_CULL_GETLIST_XNOTFOUNDINELEMENT_S            _MESSAGE(41024, _("!!!!!!!!!! lGetList(): %s not found in element !!!!!!!!!!\n"))
#define MSG_CULL_GETINT_WRONGTYPEFORFIELDXY_SS           _MESSAGE(41025, _("lGetInt: wrong type for field %s (%s)\n"))
#define MSG_CULL_GETULONG_NOSUCHNAMEXYINDESCRIPTOR_IS    _MESSAGE(41026, _("lGetUlong: no such name (%d, %s) in descriptor\n"))
#define MSG_CULL_GETSTRING_NOSUCHNAMEXYINDESCRIPTOR_IS   _MESSAGE(41027, _("lGetString: no such name (%d, %s) in descriptor\n"))
#define MSG_CULL_GETHOST_NOSUCHNAMEXYINDESCRIPTOR_IS     _MESSAGE(41028, _("lGetHost: no such name (%d, %s) in descriptor\n"))
#define MSG_CULL_GETULONG_WRONGTYPEFORFIELDXY_SS         _MESSAGE(41029, _("lGetUlong: wrong type for field %s (%s)\n"))
#define MSG_CULL_GETSTRING_WRONGTYPEFORFILEDXY_SS        _MESSAGE(41030, _("lGetString: wrong type for field %s (%s)\n"))
#define MSG_CULL_GETHOST_WRONGTYPEFORFILEDXY_SS          _MESSAGE(41031, _("lGetHost: wrong type for field %s (%s)\n"))
#define MSG_CULL_GETLIST_WRONGTYPEFORFIELDXY_SS          _MESSAGE(41032, _("lGetList: wrong type for field %s (%s)\n"))
#define MSG_CULL_GETFLOAT_WRONGTYPEFORFIELDXY_SS         _MESSAGE(41033, _("lGetFloat: wrong type for field %s (%s)\n"))
#define MSG_CULL_GETDOUBLE_WRONGTYPEFORFIELDXY_SS        _MESSAGE(41034, _("lGetDouble: wrong type for field %s (%s)\n"))
#define MSG_CULL_GETLONG_WRONGTYPEFORFIELDXY_SS          _MESSAGE(41035, _("lGetLong: wrong type for field %s (%s)\n"))
#define MSG_CULL_GETCHAR_WRONGTYPEFORFIELDXY_SS          _MESSAGE(41036, _("lGetChar: wrong type for field %s (%s)\n"))
#define MSG_CULL_GETREF_WRONGTYPEFORFIELDXY_SS           _MESSAGE(41037, _("lGetRef: wrong type for field %s (%s)\n"))
#define MSG_CULL_SETINT_WRONGTYPEFORFIELDXY_SS           _MESSAGE(41038, _("lSetInt: wrong type for field %s (%s)\n"))
#define MSG_CULL_SETULONG_WRONGTYPEFORFIELDXY_SS         _MESSAGE(41039, _("lSetUlong: wrong type for field %s (%s)\n"))
#define MSG_CULL_SETSTRING_NOSUCHNAMEXYINDESCRIPTOR_IS   _MESSAGE(41040, _("lSetString: no such name (%d, %s) in descriptor\n"))
#define MSG_CULL_SETHOST_NOSUCHNAMEXYINDESCRIPTOR_IS     _MESSAGE(41041, _("lSetHost: no such name (%d, %s) in descriptor\n"))
#define MSG_CULL_SETSTRING_WRONGTYPEFORFIELDXY_SS        _MESSAGE(41042, _("lSetString: wrong type for field %s (%s)\n"))
#define MSG_CULL_SETHOST_WRONGTYPEFORFIELDXY_SS          _MESSAGE(41043, _("lSetHost: wrong type for field %s (%s)\n"))
#define MSG_CULL_XCHGLIST_WRONGTYPEFORFIELDXY_SS         _MESSAGE(41044, _("lXchgList: wrong type for field %s (%s)\n"))
#define MSG_CULL_SETLIST_WRONGTYPEFORFIELDXY_SS          _MESSAGE(41045, _("lSetList: wrong type for field %s (%s)\n"))
#define MSG_CULL_SETFLOAT_WRONGTYPEFORFIELDXY_SS         _MESSAGE(41046, _("lSetFloat: wrong type for field %s (%s)\n"))
#define MSG_CULL_SETDOUBLE_WRONGTYPEFORFIELDXY_SS        _MESSAGE(41047, _("lSetDouble: wrong type for field %s (%s)\n"))
#define MSG_CULL_SETLONG_WRONGTYPEFORFIELDXY_SS          _MESSAGE(41048, _("lSetLong: wrong type for field %s (%s)\n"))
#define MSG_CULL_SETCHAR_WRONGTYPEFORFIELDXY_SS          _MESSAGE(41049, _("lSetChar: wrong type for field %s (%s)\n"))
#define MSG_CULL_SETREF_WRONGTYPEFORFIELDXY_SS           _MESSAGE(41050, _("lSetRef: wrong type for field %s (%s)\n" ))
#define MSG_CULL_ADDSUBSTRERRORXRUNTIMETYPE_S            _MESSAGE(41051, _("error: lAddSubStr(%s): run time type error\n"))
#define MSG_CULL_ADDSUBHOSTERRORXRUNTIMETYPE_S            _MESSAGE(41052, _("error: lAddSubHost(%s): run time type error\n"))
#define MSG_CULL_ADDELEMSTRERRORXRUNTIMETYPE_S           _MESSAGE(41053, _("error: lAddElemStr(%s): run time type error\n"))
#define MSG_CULL_ADDELEMHOSTERRORXRUNTIMETYPE_S           _MESSAGE(41054, _("error: lAddElemHost(%s): run time type error\n"))
#define MSG_CULL_DELSUBSTRERRORXRUNTIMETYPEERROR_S       _MESSAGE(41055, _("error: lDelSubStr(%s): run time type error\n"))
#define MSG_CULL_DELSUBHOSTERRORXRUNTIMETYPEERROR_S       _MESSAGE(41056, _("error: lDelSubHost(%s): run time type error\n"))
#define MSG_CULL_DELELEMSTRERRORXRUNTIMETYPEERROR_S      _MESSAGE(41057, _("error: lDelElemStr(%s): run time type error\n"))
...
#define MSG_CULL_DELELEMULONGERRORXRUNTIMETYPE_S         _MESSAGE(41065, _("error: lDelElemUlong(%s): run time type error\n"))
#define MSG_CULL_GETSUBULONGERRORXRUNTIMETYPE_S          _MESSAGE(41066, _("error: lGetSubUlong(%s): run time type error\n"))
#define MSG_CULL_GETELEMULONGERRORXRUNTIMETYPE_S         _MESSAGE(41067, _("error: lGetElemUlong(%s): run time type error\n"))
#define MSG_CULL_ADDSUBCASESTRERRORXRUNTIMETYPE_S        _MESSAGE(41068, _("error: lAddSubCaseStr(%s): run time type error\n"))
#define MSG_CULL_ADDELEMCASESTRERRORXRUNTIMETYPE_S       _MESSAGE(41069, _("error: lAddElemCaseStr(%s): run time type error\n"))
#define MSG_CULL_DELSUBCASESTRERRORXRUNTIMETYPE_S        _MESSAGE(41070, _("error: lDelSubCaseStr(%s): run time type error\n"))
#define MSG_CULL_DELELEMCASESTRERRORXRUNTIMETYPE_S       _MESSAGE(41071, _("error: lDelElemCaseStr(%s): run time type error\n"))
#define MSG_CULL_DELELEMHOSTERRORXRUNTIMETYPE_S          _MESSAGE(41072, _("error: lDelElemHost(%s): run time type error\n"))
#define MSG_CULL_GETSUBCASESTRERRORXRUNTIMETYPE_S        _MESSAGE(41073, _("error: lGetSubCaseStr(%s): run time type error\n"))
#define MSG_CULL_GETELEMCASESTRERRORXRUNTIMETYPE_S       _MESSAGE(41074, _("error: lGetElemCaseStr(%s): run time type error\n"))
#define MSG_CULL_GETELEMCASEHOSTERRORXRUNTIMETYPE_S      _MESSAGE(41075, _("error: lGetElemCaseHost(%s): run time type error\n"))
